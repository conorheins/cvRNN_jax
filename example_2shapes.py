...
def main(seed, visualize_dynamics=False, ensemble_size=1):
    ...
    seed_specific_dir = os.path.join(output_dir, f'example_2shapes_seed_{seed}')
    ...
    # models is a PyTree whose array leaves (the Bs and x0s) now have leading dim ensemble_size
    ...
    # h1s.shape == (ensemble, nt1, N)
    # h2s.shape == (ensemble, nt2-nt1, N)
